...
<div>
<form action="indexmethod!sy_hotel"  method="post">
...
<input type="submit"  value="查询"/>
           ...
           <li><a href="indexmethod!xq_hotel?id=${bean.id }"><img src="<%=basePath %>/temp/${bean.imgpath}"/></a><a href="indexmethod!xq_hotel?id=${bean.id }">${bean.name }，${bean.price }(元/日)</a></li>
             </c:forEach>
            </ul> 
            <div class="clear"></div>
